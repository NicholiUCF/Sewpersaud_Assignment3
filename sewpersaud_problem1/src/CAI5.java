...
public class CAI5 {
...

	{
	   ...
	   /*Define the function solve_problem() to perform addition, subtraction, multiplication, and division based on the choice of level*/
...

	   {
	     ...
	     /*Define the function addition() to perform addition operation based on the difficulty level*/
	     ...
	     /* Define the function subtraction() to perform subtraction based on the difficulty level*/
	   ...
	   /*Define the function multiplication to perform multiplication operation based on the difficulty level*/
...

	   {
	     ...
	     /*Define the function "division()" to perform division operation based on the difficulty level*/
